 ...
 *
 * NOTE: 此文件已从 zeroai_tui/_terminal.c 迁移至 zeroai_tui/src/_terminal.c
 *       以匹配 setup.py 的路径检测逻辑（zeroai_tui/src/_terminal.c）。
 *       原文件 zeroai_tui/_terminal.c 保留作为备份，不再参与构建。
 */
